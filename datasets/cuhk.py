...
def read_train_split_to_str(dataset_dir, use_features=False):
    """Read training data to list of filenames.

    Parameters
    ----------
    dataset_dir : str
        Path to the CUHK dataset directory; ``train_cuhk`` should be a
    ...
    """
    if use_features:
        train_dir = os.path.join(dataset_dir, "train_cuhk_features")
    else:
        train_dir = os.path.join(dataset_dir, "train_cuhk")
